...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Car.Electric passeratti = new Car.Electric("Passeratti", "Volkswagen", 2.0, 2012, "Green");
        ...
        Car.Disel bentley = new Car.Disel("Mulsanne", "Bentley", 6.8, 2020, "Orange");
        ...
        Car.LPG zentorno = new Car.LPG("zentorno", "Pegassi", 6.0, 2005, "Blue");
//        me.setSalary(-1000.0);
